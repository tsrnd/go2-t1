...
func TestGetWidthHeightSourceImageFileName(t *testing.T) {
	w, h := GetWidthHeightSourceImageFileName("test.jpg")
	assert.Equal(t, w, 0)
	assert.Equal(t, h, 0)
	w, h = GetWidthHeightSourceImageFileName("test.jpg?r=1111&h=300")
	assert.Equal(t, w, 0)
	assert.Equal(t, h, 0)
	w, h = GetWidthHeightSourceImageFileName("test.jpg?w=1111&r=300")
	assert.Equal(t, w, 0)
	assert.Equal(t, h, 0)
	w, h = GetWidthHeightSourceImageFileName("test.jpg?w=a&h=300")
	assert.Equal(t, w, 0)
	assert.Equal(t, h, 0)
	w, h = GetWidthHeightSourceImageFileName("test.jpg?w=1111&h=b")
	assert.Equal(t, w, 0)
	assert.Equal(t, h, 0)
	w, h = GetWidthHeightSourceImageFileName("test.jpg?w=111111&h=300")
	assert.Equal(t, w, 0)
	assert.Equal(t, h, 0)
	w, h = GetWidthHeightSourceImageFileName("test.jpg?w=1111&h=111111")
	assert.Equal(t, w, 0)
	assert.Equal(t, h, 0)
	w, h = GetWidthHeightSourceImageFileName("test.jpg?w=0&h=1111")
	assert.Equal(t, w, 0)
	assert.Equal(t, h, 0)
	w, h = GetWidthHeightSourceImageFileName("test.jpg?w=1111&h=0")
	assert.Equal(t, w, 0)
	assert.Equal(t, h, 0)
	w, h = GetWidthHeightSourceImageFileName("test.jpg?w=1111&h=300")
